...
import {Splashscreen, InAppBrowser, ImagePicker,SQLite,Network} from "ionic-native";
...
export class profilegroupPage {
        ...
        if(this.isInternet == 1){
            ...
            this._http.post(link, data)
                .subscribe(res => {
                    ...
                    this.opendatase('profileGroupdata');
        ...
        if(this.isInternet == 1){
            ...
            this._http.post(link, data)
                .subscribe(res => {
                    ...
                    this.groupcount = res2.length;
                    loading.dismiss();
                    this.opendatase('profilelocGroupdata');
                }, error => {
                    console.log("Oooops!");
                    loading.dismiss();
                });
        ...
        if(this.isInternet == 1){
            ...
            this._http.post(link, data)
                .subscribe(res => {
                    ...
                    this.groupcount = res2.length;
                    loading.dismiss();
                    this.opendatase('profilesugGroupdata');
                }, error => {
                    console.log("Oooops!");
                    loading.dismiss();
                });
    ...
    tableinsert(tbl){
        ...
        if(tbl == 'profileGroupdata'){
            data = JSON.stringify(this.groupList);
        }
        if(tbl == 'profilelocGroupdata'){
            data = JSON.stringify(this.groupList);
        }
        if(tbl == 'profilesugGroupdata'){
            data = JSON.stringify(this.groupList);
        }
        ...
        db.openDatabase({
            ...
            db.executeSql("SELECT * FROM "+tbl, {}).then((data) => {
                ...
                if(data.rows.length){
                    ...
                    if(tbl == 'profileGroupdata'){
                        this.groupList = JSON.parse(redata);
                    }
                    if(tbl == 'profilelocGroupdata'){
                        this.groupList = JSON.parse(redata);
                    }
